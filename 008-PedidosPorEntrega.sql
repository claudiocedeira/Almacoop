...
Convert(varchar(10), Pedido.Cantidad) as Q, '' as DONA, Pedido.Producto, Convert(varchar(10), Pedido.Precio) as 'P.U.', Convert(varchar(10), Pedido.Importe) as Imp 
from Pedido 
where Local='Av. Gral. Benjamín Victorica 2642' and Entrega='20200926'
union
