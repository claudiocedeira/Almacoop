...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ProductoAbreviatura](
	[DescrAlmacoop] [varchar](128) NOT NULL,
	[DescrAbreviada] [varchar](128) NOT NULL,
 CONSTRAINT [PK_ProductoAbreviaturas] PRIMARY KEY CLUSTERED 
(
	[DescrAlmacoop] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
